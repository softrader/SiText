"""Main entry point for SiText application."""
...
from sitext.widgets.editor import MarkdownEditor
from sitext.widgets.file_list import FileList
from sitext.widgets.hashtag_panel import HashtagPanel
from sitext.widgets.settings_screen import SettingsScreen
...
def run() -> None:
    ...
    parser = argparse.ArgumentParser(description="SiText - Terminal Note-Taking App")
    parser.add_argument(
        "--notes-dir",
        type=str,

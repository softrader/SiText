...
from sitext.gui.editor import MarkdownEditor
from sitext.gui.file_list import FileListWidget
from sitext.gui.hashtag_panel import HashtagPanel
from sitext.gui.themes import available_themes, get_stylesheet
...
class SettingsDialog(QDialog):
    ...
    def __init__(self, config: Config, parent=None):
        ...
        self.model_combo.addItems(["gpt-4o-mini", "gpt-4o", "gpt-4-turbo", "gpt-4-vision-preview", "gpt-5-mini"])
...
class MainWindow(QMainWindow):
    ...
    def _export_to_pdf(self):
        ...
        # Perform export
        from sitext.utils.pdf_export import export_to_pdf

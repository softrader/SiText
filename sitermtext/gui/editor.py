...
class MarkdownEditor(QWidget):
    ...
    def _update_autocomplete_lists(self):
        ...
        from sitermtext.utils.markdown_parser import get_available_filenames, get_hashtag_counts
    ...
    def _open_wikilink(self, link_text: str):
        ...
        from sitermtext.utils.markdown_parser import find_wikilink_target
